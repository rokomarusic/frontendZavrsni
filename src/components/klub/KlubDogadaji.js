...
class KlubDogadaji extends Component {
	constructor(props) {
		super(props)
	    this.state = {
			treneri: '',
	...
	componentDidMount() {
        ...
        axios
			.get('http://localhost:3001/penaliklub/' + this.props.idtim + "/?sezona=" + this.props.sezona + "&idklub=" + this.props.idklub)
			.then(response => {
        ...
        axios
			.get('http://localhost:3001/korneriklub/' + this.props.idtim + "/?sezona=" + this.props.sezona + "&idklub=" + this.props.idklub)
			.then(response => {
				console.log("penali ovdje")
        ...
        axios
			.get('http://localhost:3001/udarciklub/' + this.props.idtim + "/?sezona=" + this.props.sezona + "&idklub=" + this.props.idklub)
			.then(response => {
				console.log("penali ovdje")
        ...
        axios
			.get('http://localhost:3001/slobodniklub/' + this.props.idtim + "/?sezona=" + this.props.sezona + "&idklub=" + this.props.idklub)
			.then(response => {
				console.log("penali ovdje")
