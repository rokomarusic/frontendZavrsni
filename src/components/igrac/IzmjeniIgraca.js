...
class IzmjeniIgraca extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit = e => {
    ...
    axios
      .post('http://localhost:3001/admin/izmjeniigraca/', igrac)
      ...
      if(!this.state.errMsg){
        window.location = '/admin/igrac/' + igrac.idigrac
      }
  };
    ...
    return (
      <div>
        <div className="container">
          <button type="button" onClick={this.toggleVisibility}>Izmjeni igrača</button>
